...
const PalworldContext = createContext(null);

export const PalWorldStateManager = (props) => {
    ...
    const [BaseCampMaxNum, setBaseCampMaxNum] = useState(10);
    ...
    const [palWorldSettingsOutput, setPalWorldSettingsOutput] = useState("")
    ...
    const handleFormSubmit = () => {
        ...
        console.log(palWorldSettingsOutput)
    }

    return (
        <PalworldContext.Provider value={
            {
                handleCasualSettings,
                handleRecommendedSettings,
                handleHardSettings,
                palWorldSettingsOutput,
                palOptions,
                baseOptions,
                objectOptions,
                playerOptions,
            ...
            {children}
        </PalworldContext.Provider>
    )

}

PalWorldStateManager.propTypes = {
    children: PropTypes.node,
}

export function usePalWorldData () {
    return useContext(PalworldContext)
}