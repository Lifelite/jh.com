...
import {ParralaxTextBlock} from "./ParralaxTextBlock.jsx";
import ScrollInFade from "../scroll-fade-in/ScrollFadeIn.jsx";
...
export function Parallax() {
    ...
    return (
        <div className="parallax">
            ...
            <div className="intro">
                <ScrollInFade>
                    <ParralaxTextBlock color="primary" size="large">
                        Hi, I&#39;m Jeremy Huntsman...
                    </ParralaxTextBlock>
                </ScrollInFade>
                <ScrollInFade>
                    <div className="intro-body">
                        <ParralaxTextBlock color="primary" size="h2" weight="normal">
